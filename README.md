...
- Provision an EC2 instance on AWS with Ubuntu 22.04.(t2_large)
- Connect to the instance using SSH.

**Step 2: Clone the Code:**

- Update all the packages and then clone the code.(sudo apt update )
...
pipeline{
    ...
    stages {
        ...
        stage("TRIVY"){
            steps{
                sh "trivy image shivaram1918/netflix:latest > trivyimage.txt" 
            }
        }
        stage('Deploy to container'){
            steps{
                sh 'docker run -d --name netflix -p 8081:80 shivaram1918/netflix:latest'
            }
        }
    }
}
